...
public class EditModel extends javax.swing.JDialog {
    
    private final long modelId;

    public EditModel(java.awt.Frame parent, boolean modal, long modelId) {
        super(parent, modal);
    ...
    private void loadModelData() {
        final Model currentModel = ModelDao.getModel(modelId);
        this.fieldId.setEnabled(false);
        this.fieldId.setText(String.valueOf(modelId));
        this.fieldName.setText(currentModel.getName());
        this.cbAutomatic.setSelected(currentModel.isAutomatic());
        this.cbCombustion.setSelected(currentModel.isCombustion());
        final String currentBrand = currentModel.getBrand().getId() + " - " + currentModel.getBrand().getName();
        this.comboBrand.setSelectedItem(currentBrand);
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        ModelDao.updateModel(modelId, name, automatic, combustion, brandId);
        this.setVisible(false);
