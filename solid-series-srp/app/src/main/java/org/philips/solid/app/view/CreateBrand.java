...
public class CreateBrand extends javax.swing.JDialog {

    public CreateBrand(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.setTitle("Criar Marca");
    ...
    private void loadNextId() {
        final long nextId = BrandDao.getBrands().size() + 1;        
